...
#[openapi(
  paths(
    ...
    read::get_image_registry_account,
    read::list_image_registry_accounts,
    read::list_image_registries_from_config,
    // swarm
    read::list_swarms,
    ...
    read::get_variable,
    // container
    read::get_containers_summary,
    read::list_all_containers,
    read::list_containers,
    read::inspect_container,
